...
def add_writer_group(parser):
    ...
    writer_group.add_argument(
        "-c",
        "--check",
        help="Check mode, do not update the load order.  Default Behavior.",
        action="store_true",
    )
    writer_group.add_argument(
        "-u",
        "--update",
        help="Update mode, updates the load order.",
        action="store_true",
    )
    writer_group.add_argument(
        "-w",
...
def add_verbosity_group(parser):
    ...
    verbosity_group = parser.add_argument_group(
        "Verbosity Controls", "Select one of these to set how much output to receive."
    ...
    verbosity_group.add_argument(
        "-d", "--debug", help="Turn on debug output.", action="store_true"
    )
    verbosity_group.add_argument(
        "-q",
        "--quiet",
...
def add_developer_options(parser):
    ...
    developer_group = parser.add_argument_group(
        "Developer Options", "Options useful only to mlox developers."
    )
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "-n",
        "--nodownload",
        help="Do not automatically download and update the mlox rules.",
        action="store_true",
    )
    parser.add_argument(
        "-v",
